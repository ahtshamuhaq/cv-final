    ...
    <div className="content w-[100%] ">
      <div className="w-[100%] ">
        <div className=" bord ord">
          ...
          <div>
            <h1 className="    mt-4 break-words  font-extrabold  text-[17px]  text-black  hh mb-2 ml-2   ">
              {education[index].Degree.length === 0
                ? "Degree"
                : education[index].Degree}
            </h1>
            <span className="          hh  ml-2 break-words  text-[17px]  text-black   ">
              {education[index].Year.length === 0
                ? "Graduation Date"
                : education[index].Year}
            </span>
            <span className="          hh  break-words ml-2  text-[17px]  text-[#2BABE2]   ">
