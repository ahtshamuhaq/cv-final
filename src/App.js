...
function App() {
  return (
    <div className="bg-black pt-10 pb-10 h-[100%] w-full ">
      <div className="bg-cyan-900 w-[90%] h-[100%] pt-5  ml-[5%]">
        ...
        <Contact />
        <h1 className="text-3xl text-center mb-2 mt-2 ">Education Details</h1>
        <Education />
        <h1 className="text-3xl text-center mb-2 mt-2 ">Work Experience</h1>
        <Work />
      </div>
    </div>
  );
