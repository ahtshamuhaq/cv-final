            ...
            <div className="flex mb-3">
              <div className="mt-5 w-[45%]">
                ...
                <div className="form-group col-md-2 mt-4">
                  {inputList.length !== 1 && (
                    <button
                      className="bg-blue-500 mb-5 ml-10 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full"
                  ...
                  {inputList.length - 1 === i && (
                    <button
                      className="bg-blue-500  ml-10 mb-5 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full"
